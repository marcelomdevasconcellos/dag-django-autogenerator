...
@register.filter(name='is_choices_int_automate')
def is_choices_int_automate(opcoes_id):
    from automateplus.automate.models import AutomateCampos
    campos = AutomateCampos.objects.filter(opcoes_id=opcoes_id).all()
    if 'IntegerField' in campos[0].tipos.model_code:
        return True
    else:
        return False


@register.filter(name='is_choices_int')
def is_choices_int(opcoes_id):
    from automateplus.emensageriapro.models import EmensageriaCampos
    campos = EmensageriaCampos.objects.filter(opcoes_id=opcoes_id).all()
    if 'IntegerField' in campos[0].tipos.model_code:
        return True
    else:
        return False
...
def ano_mes_extenso(value):
    ...
    mes = a[1]
    if mes == '01':
        mes_extenso = u'Janeiro'
    elif mes == '02':
        mes_extenso = u'Fevereiro'
    elif mes == '03':
        mes_extenso = u'Março'
    elif mes == '04':
        mes_extenso = u'Abril'
        ...
        mes_extenso = u'Agosto'
    elif mes == '09':
        mes_extenso = u'Setembro'
    elif mes == '10':
        mes_extenso = u'Outubro'
    elif mes == '11':
        mes_extenso = u'Novembro'
    elif mes == '12':
        mes_extenso = u'Dezembro'
